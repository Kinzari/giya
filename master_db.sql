...
(49, 'vs-2526-00011', 'Agalon', 'Bossing', '', '', '', 'bossagalon@yahoo.com', '09876543210', 'Bossing123', NULL, NULL, NULL, 1, 1, 1, 10, 0);
...
(5, 'How do I create an account?', 'To create an account, you can register through our visitor registration form if you\'re not a student or employee of PHINMA-COC.', 5, 1, '2025-03-26 15:50:49', '2025-07-02 11:02:30'),
...
(8, '7-2-2025 test 123', 'hello world\n', 9, 0, '2025-03-26 18:37:49', '2025-07-02 11:02:41');
...
CREATE TABLE `tbl_giya_posts` (
  ...
  `is_read_by_admin` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Track if post has been read by admin/POC for notification purposes'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(6, 30, 1, 1, 1, '2025-02-27', '12:57:49', 'asd', 'dsa', 0, 2, 2, 0, NULL, NULL, 0),
(7, 27, 1, 1, 1, '2025-02-27', '14:55:20', 'aasd', 'asdasd', 0, 2, 6, 0, NULL, NULL, 0),
(8, 27, 4, 1, 1, '2025-02-27', '15:11:40', 'THIS IS THE TITLE', 'THIS IS A MESSAGE', 0, 2, 1, 1, 26, '2025-03-25 18:25:27', 0),
(9, 27, 1, 1, 1, '2025-02-27', '16:45:48', 'test', 'test123123', 0, 1, 5, 0, NULL, NULL, 0),
(10, 30, 4, 1, 1, '2025-02-28', '01:22:40', 'dsa', 'dsa', 0, 1, 15, 1, 26, '2025-03-25 18:14:53', 0),
(11, 27, 1, 1, 1, '2025-03-01', '16:22:25', 'test', 'test', 0, 2, 2, 0, NULL, NULL, 0),
(12, 27, 1, 1, 1, '2025-03-01', '17:56:40', 'dsa', 'dsa', 0, 3, 2, 0, NULL, NULL, 0),
(13, 30, 1, 1, 3, '2025-03-01', '19:46:58', 'suggest', 'suggest text', 0, 2, 2, 0, NULL, NULL, 0),
(14, 30, 14, 1, 2, '2025-03-04', '20:39:32', 'feedback', 'feedback', 0, 2, 6, 0, NULL, NULL, 0),
(15, 30, 4, 1, 1, '2025-03-04', '22:11:13', 'csdl', 'csdl', 0, 2, 6, 1, 26, '2025-03-25 18:21:59', 0),
(16, 45, 1, 1, 1, '2025-03-05', '00:40:36', 'academic', 'academic', 0, 2, 2, 0, NULL, NULL, 0),
...
(133, 26, 20, '2025-07-02', '19:21:09', NULL, '07-02-2025', 1, NULL),
(134, 26, 20, '2025-07-03', '12:56:11', NULL, 'test 07-03', 1, NULL),
(135, 26, 21, '2025-07-03', '13:51:42', NULL, 'go to ITS', 1, NULL),
(136, 30, 21, '2025-07-03', '13:52:03', NULL, 'OKAY THANKS', 1, NULL),
(137, 30, 20, '2025-07-04', '08:26:27', NULL, '07-04', 1, NULL),
(138, 26, 20, '2025-07-04', '11:45:18', NULL, '321', 0, NULL),
(139, 30, 20, '2025-07-04', '12:12:54', NULL, 'test 12pm', 0, NULL),
(140, 30, 20, '2025-07-04', '12:16:09', NULL, 'new feauture', 0, NULL),
(141, 26, 20, '2025-07-04', '12:16:19', NULL, 'nice', 0, NULL),
(142, 30, 20, '2025-07-04', '12:16:28', NULL, 'thanks', 0, NULL),
(143, 26, 22, '2025-07-04', '12:38:02', NULL, '07-04 new subject from admin', 0, NULL),
(144, 27, 22, '2025-07-04', '12:38:16', NULL, 'thanks admin', 0, NULL),
