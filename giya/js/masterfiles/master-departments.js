...
function initBasicDepartmentsTable() {
    try {
        ...
        const columns = [
            ...
            { data: 'department_name' },
            {
                ...
                render: function(data) {
                    return MasterTable.renderCountBadge(data, 'bg-info');
                }
            },
            {
                data: 'student_count',
            ...
            },
            {
                ...
                orderable: false,
                render: function(data) {
                    return MasterTable.renderActionButtons(data.department_id, {
                        view: true,
                        edit: true,
                        delete: true,
                        viewClass: 'view-dept',
                        editClass: 'edit-dept',
                        deleteClass: 'delete-dept'
                    });
                }
            }
        ];
        ...
        const options = {
            ajax: MasterTable.createAjaxConfig('masterfile.php?action=departments'),
            language: {
        ...
        departmentsTable = MasterTable.initTable('#departmentsTable', columns, options);
