document.addEventListener("DOMContentLoaded", function () {
    // Load navbar - use the subdirectory specific navbar
    fetch("../../dashboard-components/subdir-navbar.html")
    ...
    // Load sidebar - use the subdirectory specific sidebar
    fetch("../../dashboard-components/subdir-sidebar.html")
        .then(response => response.text())
        .then(data => {
            ...
            // Hide Master Files section for POC users
...
function hideMasterFilesForPOC() {
    ...
    if (userTypeId === '5') {
        ...
        const masterFilesMenu = document.querySelector('[data-menu="masterfiles-dropdown"]');
