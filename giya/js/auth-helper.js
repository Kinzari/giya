const AuthHelper = {
    ...
    getCurrentUser() {
        ...
        const schoolId = sessionStorage.getItem('user_schoolId');

        if (!userTypeId || !firstName || !id) {
            return null;
        }
...
function setupAxiosInterceptors() {
    // Only setup interceptors if axios is available
    if (typeof axios === 'undefined') {
        console.warn('Axios not available, skipping interceptor setup');
        return;
    }
